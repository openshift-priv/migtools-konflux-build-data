...
ENV __doozer=update BUILD_RELEASE=202509022116.p2.g3396e28.assembly.test.el9 BUILD_VERSION=v4.20.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=20 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.20.0-202509022116.p2.g3396e28.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.20 __doozer_key=oadp __doozer_uuid_tag=oadp-v4.20.0-20250902.211708 __doozer_version=v4.20.0 
ENV __doozer=merge OS_GIT_COMMIT=3396e28 OS_GIT_VERSION=4.20.0-202509022116.p2.g3396e28.assembly.test.el9-3396e28 SOURCE_DATE_EPOCH=1756384322 SOURCE_GIT_COMMIT=3396e283b156defedd56443099c61ba197eb7504 SOURCE_GIT_TAG=3396e28 SOURCE_GIT_URL=https://github.com/migtools/konflux-build-data 
COPY . /workspace
...
LABEL \
        ...
        version="v4.20.0" \
        release="202509022116.p2.g3396e28.assembly.test.el9" \
