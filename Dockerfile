...
ENV __doozer=update BUILD_RELEASE=202509032220.p2.g2d2cbcc.assembly.test.el9 BUILD_VERSION=v4.20.0 OS_GIT_MAJOR=4 OS_GIT_MINOR=20 OS_GIT_PATCH=0 OS_GIT_TREE_STATE=clean OS_GIT_VERSION=4.20.0-202509032220.p2.g2d2cbcc.assembly.test.el9 SOURCE_GIT_TREE_STATE=clean __doozer_group=openshift-4.20 __doozer_key=oadp __doozer_uuid_tag=oadp-v4.20.0-20250903.222034 __doozer_version=v4.20.0 
ENV __doozer=merge OS_GIT_COMMIT=2d2cbcc OS_GIT_VERSION=4.20.0-202509032220.p2.g2d2cbcc.assembly.test.el9-2d2cbcc SOURCE_DATE_EPOCH=1756935912 SOURCE_GIT_COMMIT=2d2cbcc36ffc18bcd58779315912ca3e5a8897e6 SOURCE_GIT_TAG=2d2cbcc36 SOURCE_GIT_URL=https://github.com/migtools/konflux-build-data 
COPY . /workspace
...
LABEL \
        ...
        version="v4.20.0" \
        release="202509032220.p2.g2d2cbcc.assembly.test.el9" \
